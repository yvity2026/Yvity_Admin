...
const menuItems = [
  {
    title: "Main",
    navitems: [
      { id: 1, label: "Dashboard", icon: <RiHomeLine /> },
      { id: 2, label: "My Profile", icon: <AiOutlineUser /> },
      { id: 2, label: "Public View", icon: <PiEyeBold /> },
    ],
  },
  {
    title: "Content",
    navitems: [
      { id: 1, label: "Professional Journey", icon: <BiPulse />, link: "/" },
      { id: 2, label: "Services", icon: <FiShield /> },
      { id: 2, label: "Acheivements", icon: <FaRegStar /> },
      { id: 2, label: "Gallery", icon: <GrGallery /> },
      { id: 2, label: "Testimonials", icon: <MdChatBubbleOutline /> },
    ],
  },
  {
    title: "Account",
    navitems: [
      { id: 1, label: "YVITY Score", icon: <RiTimeLine /> },
      { id: 2, label: "My Subsciption", icon: <LuCreditCard /> },
      { id: 2, label: "Recomendations", icon: <RxPeople /> },
      ...
      >
        ...
        <div className="mb-2 flex flex-col pl-10 pt-8 justify-between">
            <div className="w-[142px] h-full">
                ...
                <p className="text-[#F8F6F1] font-poppins text-base font-semibold">Krishna Mohan</p>
      ...
      <div className="flex flex-col flex-1 ">
        ...
        <header className="h-[60px] flex items-center justify-between border-b px-4">
          ...
          <div className="h-10 flex gap-4 py-[10px] items-center">
            <button
             className="rounded-full h-10 w-10 bg-green-300"></button>
            <button
             className="rounded-full h-10 w-10 bg-green-300"></button>
