...
const removeServicePoint = (index) => {
  ...
  return (
    <div className="px-4 sm:px-6 md:px-[90px] pt-4 sm:pt-6 md:pt-[30px] ">
      {/* Info */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
        {/* Add Card Button */}
        <div
          className="w-full md:w-[480px] min-h-[180px] md:h-[240px] flex items-center justify-center cursor-pointer hover:opacity-90 rounded-2xl border border-[#E2E1DC] bg-white shadow-none"
        >
        ...
        <div className="w-full md:w-[480px] min-h-[180px] md:h-[240px] rounded-2xl  border border-[#E2E1DC] bg-white shadow-none">
          <div className="h-[60px] px-3 sm:px-4 md:px-[30px] py-3 md:py-[18px] rounded-t-2xl bg-[#2A9D8F] shadow-[0_0_2px_0_rgba(0,0,0,0.25)] flex justify-between items-center">
            ...
            <span className="flex flex-wrap gap-2 sm:gap-[11px]">
              <button className="p-[10px] rounded-[6px] h-[26px] flex items-center border border-[#D5D5D5] bg-white text-[#0A4A4A] font-[Poppins] text-[16px] font-bold leading-normal" onClick={() => setEdit(true)}>Edit</button>
              <button className="p-[10px] rounded-[6px] h-[26px] flex items-center border border-[#F7C6C6] bg-white  text-[#D32323] font-[Poppins] text-xs font-medium leading-normal" onClick={() => setIsDelete(true)}>Delete</button>
            </span>
          </div>
          <div className="pl-3 sm:pl-4 md:pl-3 sm:pl-4 md:pl-[40px] mt-[16px] flex flex-col gap-2">
            ...
            <p className="text-[#6B7280] font-nunito text-[11px] sm:text-xs font-normal leading-4">14+ years experience</p>
    ...
    <div className="px-5 md:px-[30px] pb-6">
      ...
      <div className="mt-4 flex flex-col gap-4">
        <p className="text-[#374151] font-nunito text-sm">
          Remove <span className="font-semibold">Life Insurance</span> from your profile?
        </p>
