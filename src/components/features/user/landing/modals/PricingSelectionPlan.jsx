        ...
        handler: async function (response) {
          ...
          try {
            ...
            if (verificationRes.ok) {
              ...
              if (onSuccess) onSuccess({ plan: plan.id, success: true, paymentId: response.razorpay_payment_id });
              onClose();
            } else {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-[600px] mx-auto transition-all">
          {/* Close button */}
          <button
            onClick={onClose}
          ...
          <div className="text-center pt-8 pb-4 px-6 border-b">
            ...
            <p className="text-gray-600 mt-2 text-sm">Select the perfect plan for your needs</p>
          </div>
          ...
          <div className="px-4 py-6 space-y-4 max-h-[60vh] overflow-y-auto">
            ...
            <div className="relative">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <div className="mt-1">
                      ...
                      <span className="text-gray-600 ml-2 text-sm">Forever Free</span>
                    </div>
                  </div>
              ...
              {expandedPlan === "free" && (
                <div className="mt-3 p-4 bg-gray-50 rounded-xl border border-gray-200 animate-slideDown">
                  <h4 className="font-semibold text-gray-900 mb-2 text-sm">Features included:</h4>
            ...
            <div className="relative">
              ...
              >
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">SILVER Plan</h3>
                    <div className="mt-1">
                      <span className="text-2xl font-bold text-gray-900">₹999</span>
                      <span className="text-gray-600 ml-2 text-sm">/year</span>
                    </div>
                    <p className="text-xs text-gray-500 mt-1">Best value for professionals</p>
                  </div>
                  <div className="flex items-center space-x-2">
                    {selectedPlan === "silver" && (
                      <span className="bg-green-500 text-white px-2 py-1 rounded-full text-xs font-semibold">
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">GOLD Plan</h3>
                    <div className="mt-1">
                      <span className="text-2xl font-bold text-gray-900">₹2,999</span>
                      <span className="text-gray-600 ml-2 text-sm">/year</span>
                    </div>
                    <p className="text-xs text-gray-500 mt-1">Ultimate experience with all features</p>
                  </div>
                  <div className="flex items-center space-x-2">
                    {selectedPlan === "gold" && (
                      <span className="bg-green-500 text-white px-2 py-1 rounded-full text-xs font-semibold">
              ...
              {expandedPlan === "gold" && (
                <div className="mt-3 p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-200 animate-slideDown">
                  <h4 className="font-semibold text-gray-900 mb-2 text-sm">Premium features included:</h4>
                  <div className="grid grid-cols-1 gap-1">
          ...
          <div className="px-6 pb-6 pt-4 border-t bg-gray-50 rounded-b-2xl">
            ...
            >
              ...
              {!isProcessing && selectedPlan === "free" && "✨ Continue with FREE Plan ✨"}
              {!isProcessing && selectedPlan === "silver" && "💳 Continue to Payment (₹999/yr)"}
              {!isProcessing && selectedPlan === "gold" && "💎 Continue to Payment (₹2,999/yr)"}
            </button>

            {selectedPlan && selectedPlan !== "free" && !isProcessing && (
              <p className="text-center text-xs text-gray-500 mt-3">
                🔒 Secure payment via Razorpay • Instant activation • 30-day money-back guarantee
              </p>
            )}
