    ...
    <nav className="bg-white border-b border-gray-200 px-4 py-3 shadow-sm">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <button className="flex items-center gap-2 hover:text-black transition text-[14px] leading-[16px] font-medium text-[var(--headings-important-text,#111827)] cursor-pointer">
            <HiOutlineHome size={20} />
            <span className="font-medium">Home</span>
          </button>

          <button
            className="flex items-center gap-2  text-[14px] leading-[16px] font-medium text-[var(--headings-important-text,#111827)] cursor-pointer"
