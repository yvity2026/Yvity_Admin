              ...
              {testimonialsData.map((item, index) => (
                ...
                >
                  <span className="flex items-center flex-col gap-1">
                    <span className={` ${item.style} text-lg sm:text-xl md:text-2xl font-bold text-[#111827] text-center font-poppins text-[28px] leading-normal flex items-center gap-2`}>
                      {item.count}
