      ...
      <div className="flex items-center gap-6">
        <div className="relative w-28 h-28 flex-shrink-0 flex items-center justify-center">
          <svg className="w-full h-full transform -rotate-90" viewBox="0 0 36 36">
            <path className="text-white/20" strokeWidth="2.5" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
            <path className="text-white" strokeWidth="2.5" strokeDasharray="87, 100" strokeLinecap="round" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
          </svg>
          <div className="absolute flex flex-col items-center justify-center text-white">
            <span className="text-3xl font-bold">87</span>
            <span className="text-[10px] font-medium border-t border-white/30 pt-0.5 mt-0.5 w-8 text-center opacity-80">/100</span>
          </div>
        </div>
    ...
    <div className="bg-white/10 rounded-xl p-3 sm:px-4 sm:py-3 flex items-center gap-3 backdrop-blur-sm border border-white/10">
      ...
      <div>
        <div className="text-white font-bold leading-tight text-lg">
          {score}<span className="text-sm opacity-70">/{max}</span>
        </div>
