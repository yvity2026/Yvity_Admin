...
export default function GalleryItem({ data, onEdit, onView }) {
  return (
    <div
      className={`${data.bgColor || "bg-[#0A4A4A]"} aspect-square rounded-2xl flex items-center justify-center text-4xl sm:text-5xl shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group`}
    >
      {data.image_url ? (
