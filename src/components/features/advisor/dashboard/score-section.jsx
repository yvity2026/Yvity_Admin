...
//           <ProgressRow icon={BadgeCheck} label="Identity" value={28} max={30} color="bg-[#124B48]" />
//           <ProgressRow icon={Eye} label="Visibility" value={26} max={30} color="bg-[#F59E0B]" />
//           <ProgressRow icon={Trophy} label="Trust" value={33} max={30} color="bg-[#124B48]" />
//         </div>
//       </div>
//     </div>
//   );
...
//   // Overriding max visually for Trust to match the image precisely (33/30 shown in design)
...
//         <div className={`h-full rounded-full ${color}`} style={{ width: `${displayPercentage}%` }} />
//       </div>
