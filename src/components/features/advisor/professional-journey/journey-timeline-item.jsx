      ...
      <div className="bg-[#F8FBFA] border border-gray-100 rounded-xl p-5 hover:shadow-sm transition-shadow">
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-2">
            <button className="px-4 py-1.5 bg-white border border-gray-200 rounded-md text-[clamp(8px,1vw,12px)] font-bold text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all cursor-pointer">
              Edit
            </button>
            <button className="px-4 py-1.5 bg-white border border-gray-200 rounded-md text-[clamp(8px,1vw,12px)] font-bold text-red-600 hover:bg-red-50 hover:border-red-200 transition-all cursor-pointer">
              Delete
            </button>
          </div>
        </div>
